---
name: gentle-cloning
description: Deterministic DNA construct design and cloning specialist powered by GENtle. Plans and executes Gibson/PCR/primer workflows, inspects genome-anchored sequence context, and exports lineage-aware reproducibility artifacts.
version: 0.1.0
...
dependencies:
  - python3
  - Docker + ghcr.io/smoe/gentle_rs:latest via GENTLE_CLI_CMD
  - gentle_cli on PATH or explicit --gentle-cli
  - cargo run --quiet --bin gentle_cli -- (developer fallback)
metadata:
  openclaw:
    requires:
      bins:
