...
def test_run_skill_promotes_structured_result_fields(monkeypatch, tmp_path: Path):
            ...
            json.dumps(
                {
                    ...
                    "chat_summary_lines": [
                        "Reference genome is not prepared.",
                        "ATtRACT helper snapshot is out of date.",
                    ],
                    ...
                    "suggested_actions": [
                        {
                            ...
                            "kind": "request",
                            "request": {
                                "schema": "gentle.request.v1",
                                "command": "genomes prepare grch38",
                            },
    ...
    assert result["suggested_actions"][0]["action_id"] == "prepare-grch38"
